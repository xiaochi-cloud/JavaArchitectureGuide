...
![34.jpg](./assets/1713179399179-db6bd6ef-aa68-4686-9435-91802896d7da-20240424105556422.jpeg)
...
![36.jpg](./assets/1713179580423-e6baa3d2-ae50-4478-86b8-fba51652d253-20240424105556623.jpeg)
...
![37.jpg](./assets/1713179724108-68a9025d-fbab-4d39-b10a-ce37c71bf0c5-20240424105556536.jpeg)

#### 记录部分 (User Records & Free Space)

页的主要作用是存储记录，所以“最小和最大记录”和“用户记录”部分占了页结构的主要空间。另外空闲空间是个灵活的部分，当有新的记录插入时，会从空闲空间中进行分配用于存储新记录
![38.jpg](./assets/1713179775912-1309cbfb-6bdd-48df-a987-4cca7bc20e28-20240424105556497.jpeg)
...
![39.jpg](./assets/1713179877649-5fdd8f34-fda6-4c8a-9b7e-cb21b6de9509-20240424105556588.jpeg)
...
#### 1.3.1.1 COMPACT 行记录格式

![image.png](./assets/1713180083973-e916b885-e3e7-4093-9509-ce89bf5697fa-20240424105556578.png)

- Compact 设计目标是高效地存储数据，一个页中存放的行数据越多，其性能就越高。
- Compact 行记录由两部分组成: 记录放入额外信息和 记录的真实数据.

以这条记录为例
![image.png](./assets/1713180846456-c3db3262-e9f7-4cf3-a491-15b7542b762a-20240424105556515.png)
...
![image.png](./assets/1713180530857-19df7cd1-c4c2-479b-b9a5-dc2cecfedef3-20240424105556653.png)
最终记录是
![image.png](./assets/1713180791436-7d1b0a87-354f-4311-abd1-63bc15f1bae1-20240424105556620.png)

######  记录头信息

   - 记录头信息是由固定的5个字节组成，5个字节也就是40个二进制位，不同的位代表不同的意思，这些头信息会在后面的一些功能中看到。 

![image.png](./assets/1713180446450-e14ca2ce-6162-4f49-b521-287a021e7f27-20240424105556683.png)
...
![image.png](./assets/1713180959619-d58695ad-bb23-4591-a899-d29f1632a178-20240424105556666.png)!

> 实际上这几个列的真正名称其实是：DB_ROW_ID、DB_TRX_ID、DB_ROLL_PTR，我们为了美观才写成了row _id、transaction_id和roll_pointer。

![image.png](./assets/1713181040876-9fc8a228-8bc5-4d18-92ed-6100cae2bac7-20240424105556733.png)
生成隐藏主键列的方式有: 
...
![53.jpg](./assets/1713233128414-e05edccf-c3c2-40d1-a0ae-4b8a1f70cdae-20240424105556683.jpeg)

#### 1.3.1.2 DYNAMIC 和 COMPRESSED 行记录格式
...
![53.jpg](./assets/1713233212495-083a74cf-26b2-45c9-beed-9ba1904d5700-20240424105556704.jpeg)
...
![52.jpg](./assets/1713233237973-accebc4e-fcd6-425b-843a-b5eac52eead9-20240424105556741.jpeg)
