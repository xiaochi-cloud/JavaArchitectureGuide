...
- 2024/04/23 📝 🧠 【MySQL】添加了数据库准备和优化原则的详细说明，包括创建、插入、索引等操作，解释了最左匹配原则，并提供了示例和分析，总结了优化原则和解决方案。[003-索引优化原则](articles/mysql/002%20MySQL索引原理&优化/003-索引优化原则.md)
  - 🔍 🚀 【MySQL】分析了导致索引失效的操作，包括在索引列上做计算、范围查询等，提供了解决方法，更新了README文档。 
